...
DESCRIPTION
    ...
    This project involves the implementation of autoencoder for automatic 
...
DATASET
   ...
   The dataset used for this project can be found here "https://archive.ics.uci.edu/ml/datasets/MoCap+Hand+Postures#"

STEPS

1) Define an MLP Architecture involving 3 layers  

   a. Perform PCA Analysis to investigate the ideal minimum and maximum number of hidden layers that can be used.

   b. Monitor the loss function and average cross entropy, update the weights and thresholds through gradient descent
      during learning 


2) Use of Confusion Matrix, Training and Test sets accuracies for performance analysis
   result: More than 80% accuracy for the classification method was obtained.

3) Investigation of the effects of performance on several parameters like 
...
"""Import and shuffle the data to achieve randomness and ensure there is no hidden order in the dataset

   Select Only three classes and 15 features
   
   This is because some of the features have incomplete data and are thus eliminated.
...
""" Select 2 tentative sizes (h) for the hidden layer by PCA Analysis """


"Scale and Splite the data into training and test sets (80%:20%)"
...
"Retrieve the classes in the training and test sets"
...
"Display the number of classes in the training and test sets"
...
"Find the Covariance Matrix for the training set and display the first 4 rows of data"
...
"Find the Eigen values and eigen vectors and display the results"
...
"""
Find the smallest number (h95) that explain about 95% variance in our data.
...
"""
Perform PCA analysis on the input training set and plot it in 3 dimension

to see if the projection of the classes are well separated or not
...
"Plot of the principal components in 3 Dimensions"
...
Perform PCA Analysis for each of the classes
...
"""
Find the smallest number (h95) that explain about 95% variance in Class 1

This number is estimated from the plot above and code below

h95 will thus be set as U1 for Class 1
...
"""
Perform a PCA analysis on Class 1 input training set and plot in 3 dimension
"""
...
"Project  Class 1 in 3 Dimension"
...
"""
Find the smallest number (h95) that explain about 95% variance in Class 2

This number is estimated from the plot above and code below

h95 will thus be set as U2 for Class 2
...
"""
Perform a PCA analysis on Class 2 input training set and plot in 3 Dimension
"""
...
"Project Class 2 in 3 dimension"
...
"""
Find the smallest number h95 that explain about 95% variance in Class 3

This number is estimated from the plot above and code below

h95 will thus be set as U3 for Class 3
...
"""
Perform a PCA analysis on Class 3 input training set and plot in 3 dimension
"""
...
"Project Class 3 in 3 Dimension"
...
""" The larger plausible value of h95 can thus be calculated as follows"""
...
def fun (b,w,l, h ):
    ...
    It takes as an input, the batch-size, the seed number for defining different initialization of weights and biases,
...
""" Plot the Batch-Size Loss Function """
...
"""
    Find the smallest number Ub that explains about 95% variance of the
    
    global states of the hidden layer
    
    This number can be estimated from the plot above and code below
...
"""
    ...
    Analysis of the capacity of each neurons to differentiate between the classes
    
    should be done using the plots below
    
"""    

"""

    Plot the average activity profiles for Class 1, 2 and Class 3 (PROF 1, 2 and PROF 3)
     
    Investigate the capacity of each neurons to differentiate between Class 1, Class 2, and Class 3
...
""" 
    Plot the average activity profiles for Class 1 and Class 2 (PROF 1 and PROF 2)
    
    Investigate the capacity of each neurons to differentiate between Class 1 and Class 2
...
""" 
     Plot the average activity profiles for Class 1 and Class 3 (PROF 1 and PROF 3)

     Investigate the capacity of each neurons to differentiate between Class 1 and Class 3
...
""" 
    Plot the average activity profiles for Class 2 and Class 3 (PROF 2 and PROF 3)

    Investigate the capacity of each neurons to differentiate between Class 2 and Class 3
